...
internal class DrawingViewUndoRedoTest : BaseDrawingViewTest() {
    ...
    fun testUndoAndRedoWithListenerWhenAnythingIsDrawnOnCanvas() {
        val brushViewChangeListener = Mockito.mock(BrushViewChangeListenerOriginal::class.java)
    ...
    private fun verifyUndo(
        drawingView: DrawingViewOriginal,
        brushViewChangeListener: BrushViewChangeListenerOriginal
    ) {
