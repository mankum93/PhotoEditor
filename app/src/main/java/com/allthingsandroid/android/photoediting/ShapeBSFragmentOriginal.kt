...
import com.allthingsandroid.android.photoediting.ColorPickerAdapter.OnColorPickerClickListener
...
class ShapeBSFragmentOriginal : BottomSheetDialogFragment(), SeekBar.OnSeekBarChangeListener {
